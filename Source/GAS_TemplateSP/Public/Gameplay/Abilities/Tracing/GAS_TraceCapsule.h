 ...
 */
UCLASS()
class GAS_TEMPLATESP_API UGAS_TraceCapsule : public UGAS_TraceBase
{
	GENERATED_BODY()
	
public:

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "TraceCapsule", meta = (ExposeOnSpawn = true))
	float Radius = 100.0f;
