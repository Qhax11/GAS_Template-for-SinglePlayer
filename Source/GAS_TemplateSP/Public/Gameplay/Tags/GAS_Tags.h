...
namespace GAS_Tags
{
	...
	*************************************************/
	...
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_DeadWithFinisher);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Vulnerable);
