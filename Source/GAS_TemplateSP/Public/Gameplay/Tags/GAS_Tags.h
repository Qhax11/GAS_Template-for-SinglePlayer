...
namespace GAS_Tags
{
	...
	*************************************************/
	...
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_AttackState_Enter);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_AttackState_Exit);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_MovementState_Enter);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_MovementState_Exit);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_InComingAttackState_Enter);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_AI_StateTreeEvent_Transaction_InComingAttackState_Exit);
