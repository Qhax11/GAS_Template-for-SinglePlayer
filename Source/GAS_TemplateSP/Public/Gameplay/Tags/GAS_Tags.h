...
namespace GAS_Tags
{
	...
	*************************************************/
	...
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AttackEvent_LockRotationTowardsTarget);
	GAS_TEMPLATESP_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AttackEvent_UnLockRotationTowardsTarget);
