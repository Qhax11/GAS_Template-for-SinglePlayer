...
{
	UGAS_Task_PlayMontageWaitForEvent* Task = UGAS_Task_PlayMontageWaitForEvent::PlayMontageAndWaitForEvent(this, NAME_None, Montage, WaitForEventTag, PlayRate, NAME_None, bStopWhenAbilityEnds, 1.0f);
