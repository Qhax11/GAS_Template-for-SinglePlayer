...
namespace GAS_Tags
{
	...
	*************************************************/
	...
	UE_DEFINE_GAMEPLAY_TAG(TAG_Gameplay_AbilityTriggerEvent_ShadowCombo, "Gameplay.AbilityTriggerEvent.ShadowCombo");
	...
	UE_DEFINE_GAMEPLAY_TAG(TAG_Gameplay_State_Phase_Active_Dodge, "Gameplay.State.Phase.Active.Dodge");
	...
	****************************************************/
	...
	UE_DEFINE_GAMEPLAY_TAG(TAG_GameplayCue_Sound_PlayOnTarget_Footstep, "GameplayCue.Sound.PlayOnTarget.Footstep");
